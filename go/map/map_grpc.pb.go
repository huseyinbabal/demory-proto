...
func (c *mapClient) Put(ctx context.Context, in *PutRequest, opts ...grpc.CallOption) (*emptypb.Empty, error) {
...
func (UnimplementedMapServer) Put(context.Context, *PutRequest) (*emptypb.Empty, error) {
